...
$(ObjDir)/tb_axil_macc.cpp_pre.cpp.tb.o : tb_axil_macc.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_axil_macc.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/axil_macc.cpp_pre.cpp.tb.o : axil_macc.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axil_macc.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
