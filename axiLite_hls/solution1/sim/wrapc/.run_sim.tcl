...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axil_macc.autotvin.dat"
	set constFileTvOut       "axil_macc.autotvout.dat"
	set constFileHdlTvIn     "axil_macc.autohdltvin.dat"
	set constFileHdlTvOut    "axil_macc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
