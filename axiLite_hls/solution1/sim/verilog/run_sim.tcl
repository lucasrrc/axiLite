...
if {[file isfile axil_macc.autotvin.dat]} {
	file delete -force axil_macc.autotvin.dat
}

if {[file isfile axil_macc.autotvout.dat]} {
	file delete -force axil_macc.autotvout.dat
}
