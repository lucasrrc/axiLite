# 1 "axiLite_hls/source/axil_macc.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "axiLite_hls/source/axil_macc.cpp" 2
__attribute__((sdx_kernel("axil_macc", 0))) void axil_macc(int *a, int *b, int *c, int *instr)
{
#line 15 "C:/Users/lrluc/Documents/Academia/hardwareDescription/examples/axiLite/axiLite_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=axil_macc
# 2 "axiLite_hls/source/axil_macc.cpp"
