...
localparam
    ...
    ADDR_C_DATA_0     = 6'h20,
    ADDR_C_CTRL       = 6'h24,
    ADDR_INSTR_DATA_0 = 6'h30,
    ADDR_INSTR_CTRL   = 6'h34,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INSTR_DATA_0: begin
                    rdata <= int_instr[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_INSTR_DATA_0)
            int_instr[31:0] <= (WDATA[31:0] & wmask) | (int_instr[31:0] & ~wmask);
    end
end
